...
def support():
    ...
    if request.method == "POST":
        ...
        if not name:
            return render_template("support.html", error="Please enter a name.", code=code, name=name)

        if join != False and not code:
            return render_template("support.html", error="Please enter a room code.", code=code, name=name)
        ...
        if create != False:
            ...
            return render_template("support.html", error="Room does not exist.", code=code, name=name)
